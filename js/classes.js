...
class Fighter extends Sprite {
    ...
    switchSprite(sprite) {
        ...
        if (this.image === this.sprites.death.image) {
            if (this.framesCurrent === this.sprites.death.numFrames - 1) this.isDead = true;
            return;
        }

        //overriding all other animations with the attack animation
        if (this.image === this.sprites.attack1.image &&
            this.framesCurrent < this.sprites.attack1.numFrames - 1) return;

        //overriding all other animations when fighter gets hit
        if (this.image === this.sprites.takeHit.image &&
            this.framesCurrent < this.sprites.takeHit.numFrames - 1) return;
